...
class MainView(MainViewInterface):
    ...
    def _init_widgets(self) -> None:
        ...
        self._gpu_name_entry: Gtk.Entry = self._builder.get_object('gpu_name_entry')
        self._gpu_vbios_entry: Gtk.Entry = self._builder.get_object('gpu_vbios_entry')
        self._gpu_driver_entry: Gtk.Entry = self._builder.get_object('gpu_driver_entry')
        self._gpu_pcie_entry: Gtk.Entry = self._builder.get_object('gpu_pcie_entry')
        self._gpu_cuda_entry: Gtk.Entry = self._builder.get_object('gpu_cuda_entry')
        self._gpu_uuid_entry: Gtk.Entry = self._builder.get_object('gpu_uuid_entry')
        self._gpu_memory_entry: Gtk.Entry = self._builder.get_object('gpu_memory_entry')
        self._gpu_memory_interface_entry: Gtk.Entry = self._builder.get_object('gpu_memory_interface_entry')
        self._gpu_memory_usage_entry: Gtk.Entry = self._builder.get_object('gpu_memory_usage_entry')
        self._gpu_usage_entry: Gtk.Entry = self._builder.get_object('gpu_usage_entry')
        self._gpu_encoder_usage_entry: Gtk.Entry = self._builder.get_object('gpu_encoder_usage_entry')
        self._gpu_decoder_usage_entry: Gtk.Entry = self._builder.get_object('gpu_decoder_usage_entry')
        self._gpu_power_draw_entry: Gtk.Entry = self._builder.get_object('gpu_power_draw_entry')
        self._gpu_power_limit_entry: Gtk.Entry = self._builder.get_object('gpu_power_limit_entry')
        self._gpu_power_default_entry: Gtk.Entry = self._builder.get_object('gpu_power_default_entry')
        self._gpu_power_min_entry: Gtk.Entry = self._builder.get_object('gpu_power_min_entry')
        self._gpu_power_enforced_entry: Gtk.Entry = self._builder.get_object('gpu_power_enforced_entry')
        self._gpu_power_max_entry: Gtk.Entry = self._builder.get_object('gpu_power_max_entry')
        self._gpu_clock_graphics_current_entry: Gtk.Entry = self._builder.get_object('gpu_clock_graphics_current_entry')
        self._gpu_clock_graphics_max_entry: Gtk.Entry = self._builder.get_object('gpu_clock_graphics_max_entry')
        self._gpu_clock_sm_current_entry: Gtk.Entry = self._builder.get_object('gpu_clock_sm_current_entry')
        self._gpu_clock_sm_max_entry: Gtk.Entry = self._builder.get_object('gpu_clock_sm_max_entry')
        self._gpu_clock_memory_current_entry: Gtk.Entry = self._builder.get_object('gpu_clock_memory_current_entry')
        self._gpu_clock_memory_max_entry: Gtk.Entry = self._builder.get_object('gpu_clock_memory_max_entry')
        self._gpu_clock_video_current_entry: Gtk.Entry = self._builder.get_object('gpu_clock_video_current_entry')
        self._gpu_clock_video_max_entry: Gtk.Entry = self._builder.get_object('gpu_clock_video_max_entry')
        self._gpu_memory_usage_levelbar: Gtk.LevelBar = self._builder.get_object('gpu_memory_usage_levelbar')
        self._gpu_usage_levelbar: Gtk.LevelBar = self._builder.get_object('gpu_usage_levelbar')
        self._gpu_encoder_usage_levelbar: Gtk.LevelBar = self._builder.get_object('gpu_encoder_usage_levelbar')
        self._gpu_decoder_usage_levelbar: Gtk.LevelBar = self._builder.get_object('gpu_decoder_usage_levelbar')
        ...
        self._mem_clock_offset_adjustment: Gtk.Adjustment = self._builder.get_object('mem_clock_offset_adjustment')
        ...
        if status:
            ...
            if self._first_refresh:
                ...
                if gpu_status.overclock.available:
                    ...
                    self._mem_clock_offset_scale.clear_marks()
                    self._mem_clock_offset_scale.add_mark(0, Gtk.PositionType.BOTTOM, str(0))
            ...
            if gpu_status.overclock.available:
                self._gpu_clock_offset_adjustment.set_lower(gpu_status.overclock.gpu_range[0])
                self._gpu_clock_offset_adjustment.set_upper(gpu_status.overclock.gpu_range[1])
